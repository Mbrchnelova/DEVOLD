      ...
      else if (geom == "pr".or.geom == "PR".or.geom == "Pr") then
        call write_prism(pathin, pathout)

      else if (geom == "Wa".or.geom == "wa".or.geom == "WA") then
        call write_walpot(pathin, pathout)
      ...
      subroutine write_prism(pathin, pathout)
      integer :: ios
      ...
      do i = 1, numnp
         ...
         write(write_unit, "(I10,3E20.11)") nodidx, coordx, coordy, &
      coordz
      ...
      do i = 1, nelem
         ...
         if (nnodes == 6) then
           ...
           cellidx, celltype, nnodes, n1, n2, n3, n4, n5, n6
         else if (nnodes == 3) then
           write(write_unit, "(I8,1X,I2,1X,I2,1X,4I8)") &
           cellidx, celltype, nnodes, n1, n2, n3
         end if
      end do
      ...
      write(write_unit, "(A32, 8I10)") "Inlet", 1, n1, 0, 12
      ...
      write(write_unit, "(A32, 8I10)") "Outlet", 1, n2, 0, 25
     ...
     write(write_unit, "(A)") "ENDOFSECTION"
      ...
      subroutine write_walpot(pathin, pathout)
      ...
      write(write_unit, "(A32, 8I10)") "Inlet", 1, n1, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "Outlet", 1, n2, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "Wall", 1, n3, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "Symmetry", 1, n4, 0, 6
